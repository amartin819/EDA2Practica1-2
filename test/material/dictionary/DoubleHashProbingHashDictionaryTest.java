 ...
 * @author jvelez
 */
public class DoubleHashProbingHashDictionaryTest extends TestCase{
    
    private OAHashDictionary<String, Integer> listin;
    @Test
    public void testSize() {
        listin = new OAHashDictionary<>(new LinearProbing());
...
@Test
    ...
    public void testRehash() {
        OAHashDictionary<Integer, Integer> listin1 = new OAHashDictionary<>(10,new LinearProbing());
